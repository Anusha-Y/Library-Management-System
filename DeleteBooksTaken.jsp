<%-- 
    Document   : DeleteBooksTaken
    Created on : Dec 4, 2022, 6:37:47 PM
    Author     : ANUSHA
--%>
    ...
    <center><table border="1">
                <tr class="t">
                   ...
                   <tr>
                        ...
                        <td><a href="DeleteBooksTakenBE.jsp?StudentId=<%=rs.getInt(1)%>" class="l">Delete</a></td>
                   </tr>
                   <%  }
                con.close();
                    %>
